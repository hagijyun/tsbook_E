...
##Object suitable for handling time series data
...
# Artificial second time series (shifting back the start time of the Nile to 5 years ago)
...
# A sequence of time informations
time(Nile)
```
...
# Generate consecutive Date class object
...
# Extract the information about the day of the week
weekdays(days)
```
