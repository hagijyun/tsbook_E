...
curve(dunif (x, min    = 0  , max    = 1  ),  0,  1, xlab = "Realizations", ylab = "Density")
curve(dbeta (x, shape1 = 0.5, shape2 = 0.5),  0,  1, xlab = "Realizations", ylab = "Density")
curve(dgamma(x, rate   = 1  , shape  = 2  ),  0, 10, xlab = "Realizations", ylab = "Density")
```
...
# One dimension
curve(dnorm, -3,  3, xlab = "Realizations", ylab = "Density")
...
##Relationship among multiple random variables
...
# Generate points on the circle with center 0 and radius 1 as dependent two variables
...
# Setting of random seed (ensuring reproducibility)
set.seed(1234)

# Set time series length, allocate memory for observations
t_max <- 800
